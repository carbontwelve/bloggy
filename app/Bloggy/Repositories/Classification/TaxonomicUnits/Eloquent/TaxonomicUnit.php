...
use Bloggy\Repositories\Classification\TaxonomicUnits\TaxonomicUnitInterface;
...
class TaxonomicUnit extends Model implements TaxonomicUnitInterface {
    ...
    public function validate($rule)
    {
        ...
        $validator = Validator::make( $this->attributesToArray(), self::$rules[$rule] );
    ...
    public function term()
    {
        ...
        $termModel = '\Bloggy\Repositories\Classification\Terms\Eloquent\Term';

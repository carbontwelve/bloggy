...
use Bloggy\Repositories\Classification\TaxonomicUnits\ProviderInterface;
...
class TaxonomicUnitProvider implements ProviderInterface {
     ...
     * @var string
     */
    protected $model = '\Bloggy\Repositories\Classification\TaxonomicUnits\Eloquent\TaxonomicUnit';

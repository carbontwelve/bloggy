...
use Bloggy\Repositories\Classification\TaxonRelationship\ProviderInterface;
...
class TaxonRelationshipProvider implements ProviderInterface {
     ...
     * @var string
     */
    protected $model = 'Bloggy\Repositories\Classification\TaxonRelationship\Eloquent\TaxonRelationship';
